...
CREATE TABLE Address_12 (
  ...
  last_update DATE NOT NULL,
  CONSTRAINT pk1_address PRIMARY KEY (address_id)
);

CREATE  INDEX idx_fk_city_id ON address_12(city_id);
/

ALTER TABLE address_12 ADD  CONSTRAINT fk_address_city FOREIGN KEY (city_id) REFERENCES city (city_id);
/
...
BEFORE INSERT ON address_12 FOR EACH ROW 
BEGIN
...
BEFORE UPDATE ON address_12 FOR EACH ROW 
BEGIN
  :NEW.last_update:=current_date;
END;
/
...
CREATE TABLE customer_1 (
  ...
  last_update DATE NOT NULL,
  CONSTRAINT pk_customer_1 PRIMARY KEY  (customer_id),
  CONSTRAINT fk_customer_address_1 FOREIGN KEY (address_id) REFERENCES address(address_id)
);

CREATE  INDEX idx_customer_fk_store_id ON customer_1(store_id);
/
CREATE  INDEX idx_customer_fk_address_id ON customer_1(address_id);
/
CREATE  INDEX idx_customer_last_name ON customer_1(last_name);
/
...
BEFORE INSERT ON customer_1 FOR EACH ROW 
BEGIN
...
BEFORE UPDATE ON customer_1 FOR EACH ROW 
BEGIN
  :NEW.last_update:=current_date;
END;
/
...
CREATE TABLE payment (
  ...
  CONSTRAINT fk_payment_customer FOREIGN KEY (customer_id) REFERENCES customer_1 (customer_id) ,
...
CREATE TABLE rental (
  ...
  CONSTRAINT fk_rental_customer FOREIGN KEY (customer_id) REFERENCES customer_1 (customer_id)
);
...
ALTER TABLE customer_1 ADD CONSTRAINT fk_customer_store FOREIGN KEY (store_id) REFERENCES store (store_id);
/
ALTER TABLE inventory ADD CONSTRAINT fk_inventory_store_1 FOREIGN KEY (store_id) REFERENCES store (store_id);
/
ALTER TABLE staff ADD CONSTRAINT fk_staff_store_1 FOREIGN KEY (store_id) REFERENCES store (store_id);
/
ALTER TABLE payment ADD CONSTRAINT fk_payment_rental_1 FOREIGN KEY (rental_id) REFERENCES rental (rental_id) ON DELETE SET NULL;
/
--
...
SELECT cu.customer_id AS ID,
       ...
       cu.store_id AS SID
FROM customer_1 cu JOIN address a ON cu.address_id = a.address_id JOIN city ON a.city_id = city.city_id
